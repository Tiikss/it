        ...
        <div className="conteiner-home">
            ...
            <div className="main-home">
                ...
                <div id="firstdiv-home" className="cards-home">
                    ...
                    <p className="home-p">Kurs je namenjen potpunim početnicima ili onima koji žele da osveže svoje osnovno znanje engleskog
                ...
                <div id="seconddiv-home" className="cards-home">
                    ...
                    <p className="home-p">Kurs je idealan za one koji već imaju osnovno znanje engleskog jezika i žele da unaprede svoju
                ...
                <div id="thirddiv-home" className="cards-home">
                    ...
                    <p className="home-p">Dobrodošli na kurs engleskog jezika naprednog nivoa! Ovaj kurs je namenjen polaznicima koji već dobro
